...
export default function ChargeCorrection() {
  ...
  return <div className="mx-auto max-w-2xl p-4 lg:p-8">
    ...
    <div className="rounded-2xl border bg-card p-6 shadow-sm">
      ...
      <dl className="mt-6 grid grid-cols-2 gap-4 rounded-xl bg-muted/50 p-4 text-sm"><div><dt className="text-muted-foreground">Session</dt><dd className="font-bold">{charge.session_type}</dd></div>{charge.school_year && <div><dt className="text-muted-foreground">Année scolaire</dt><dd className="font-bold">{charge.school_year}</dd></div>}<div><dt className="text-muted-foreground">Service</dt><dd className="font-bold">{charge.service_description}</dd></div><div><dt className="text-muted-foreground">Prix net</dt><dd className="font-bold">{money(charge.net_amount)} MAD</dd></div><div><dt className="text-muted-foreground">Solde actuel</dt><dd className="font-bold">{money(charge.balance)} MAD</dd></div></dl>
