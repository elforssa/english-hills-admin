...
drop function public.search_students_page(text,text,text,text,text,boolean,text,text,integer,integer);
...
revoke all on function public.search_students_page(text,text,text,text,text,boolean,text,text,integer,integer,text) from public, anon, authenticated;
grant execute on function public.search_students_page(text,text,text,text,text,boolean,text,text,integer,integer,text) to authenticated;
