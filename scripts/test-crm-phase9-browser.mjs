...
try {
 ...
 values('${mapping}','website','${connection}','annual','Programme annuel',1,'{"learner_name":"child"}','{"child":"Apprenant","days":"Jours préférés"}','Annual','Yearly','2020-01-01','${director.id}');commit;`);
 ...
 console.log('PASS browser consent helper, navigation persistence, actual cross-origin inquiry/retry/conflict, queue processing, protected attribution, normal receptionist drawer/mobile, no center side effects');
} finally {
